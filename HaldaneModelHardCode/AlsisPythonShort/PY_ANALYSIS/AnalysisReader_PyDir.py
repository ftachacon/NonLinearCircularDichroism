...
print("Ellip  = ", ellip, " " );
print("\n\n Time-step dt  = ", Params[0,5], " a.u. " );
print("Total No. of time-steps  = ", Params[0,4], " \n" );
...
ta 	    = t[0]  + T0*4.0;#T0*3.0;
tb 	    = t[-1] - T0*4.0;#T0*3.0;
...
plt.legend([p1, p2,p3], ['$J_{+}$', '$J_{-}$', '$J_{tot}$' ],fontsize=18);
...
yticks0  = [-20., -15., -10., -5., 0., 5. ]#10., 15, 5.0];
plt.yticks( yticks0 );
