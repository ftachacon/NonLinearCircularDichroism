...
ofname          = "/HHG__Phi0__" + str("%.3f"%Phi0) + "__M0t2__" + str("%.3f"%M0t2) + "__e0__" + str("%.3f"%ellip) + "__G1G2.dat"
...
xaxmax      = 31.; # controling harmonic-order axis limits, u
...
fig  = plt.figure(figsize=(width,hight) )
ax1  = fig.add_axes([0.2, 0.15, 0.75, 0.75])
p1,  = plt.plot( w[Nthalf:Nt-1]/w0, a_dJ_m[Nthalf:Nt-1], 'b-', lw = 2., label='$J_{x}$' );
p2,  = plt.plot( w[Nthalf:Nt-1]/w0, a_dJ_p[Nthalf:Nt-1], 'r',  lw = 1.5, label='$J_{y}$' );
...
plt.legend([p1,p2], ['LCP--orders','RCP--orders' ],fontsize=18);
...
yticks0  = np.arange(-16,40,4);#[-25.,-20., -15., -10., -5., 0., 5. ]#10., 15, 5.0];
plt.xticks( xticks0 );
plt.yticks( yticks0 );
