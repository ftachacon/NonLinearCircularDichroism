...
ax      = fig.add_axes([0.149, 0.165, 0.825, 0.79]);
...
plt.legend([p2,p3], [r'$\rm Gauge\,\,B\,\,$',r'$\rm Variable-Gauge\,A-B$'],fontsize=31);

xticks0  = np.arange(1,50,4);
plt.xticks( xticks0 );
plt.text(1.25, 1e-2, r"$(f\,)\,\, Trivial$", fontsize=41, color="k");
...
fname='Figure2f.pdf'#'Gauge__Comparison__TopologicalF.pdf'
