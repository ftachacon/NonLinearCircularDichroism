...
p1,=plt.plot( om, hhgtriv/4. + hzero, 'b',  lw=2.75 );
...
plt.legend([p1, p2], [r'$\rm Gauge\,\,A\,\,$', r'$\rm Gauge\,\,B$'],fontsize=35);

xticks0  = np.arange(1,50,4);
plt.xticks( xticks0 );
plt.text(1.25, 1e-2, r"$(g)\,\, Topological$", fontsize=41, color="k");
plt.yscale('log');
plt.xlim( [0, 33] );
...
fname='Figure2g.pdf'#'Gauge__Comparison__TopologicalE.pdf'
