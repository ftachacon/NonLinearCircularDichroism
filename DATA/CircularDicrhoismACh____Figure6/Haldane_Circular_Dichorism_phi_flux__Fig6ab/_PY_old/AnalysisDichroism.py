...
ofname          = "/Haldane__Phase__Params__" + str("%.3f"%Phi0) + "__M0t2__" + str("%.3f"%M0t2) + "__.dat"
out             = ProjPath + ofname;
...
ofname          = "/Dichroism__Phi0__" + str("%.3f"%Phi0) + "__M0t2__" + str("%.3f"%M0t2) + "__.dat";
out             = ProjPath + ofname;
...
xaxmin      = 0;    # controling harmonic-order axis limits, down
xaxmax      = 37;   # controling harmonic-order axis limits, up
plt.xlim(xaxmin, xaxmax);
