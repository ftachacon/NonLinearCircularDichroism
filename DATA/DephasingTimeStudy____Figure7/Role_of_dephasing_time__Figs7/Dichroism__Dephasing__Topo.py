...
p2,=plt.plot(order3n1[:,0],cd_3n1[:,1],'*',color=[0.0,1,0],     markersize=15,label=r'$\,\,\,= 330$')
p3,=plt.plot(order3n1[:,0],cd_3n1[:,2],'s',color=[0.9,0,0],   markersize=9,label=r'$\,\,\,= 440$')
plt.legend([p1, p2, p3], [r'$T_2\,=\,\,220\,\rm a.u.$',r'$  \,\,\,\,=\,\, 330$',r'$  \,\,\,\,=\,\, 440$'],loc='lower right',fontsize=27);
...
plt.ylim( ymin, ymax );
plt.xlim( xmin, xmax );
plt.text(0.3, 1.06e-0, r'$\rm\,(d)\,Topological\,\,3n+1$', fontsize=27, color="k");
#plt.text(1, 1e-0, r'$\rm\,\,\,\,\,\,    Topological\,\,\,3n+1$', fontsize=28, color="k");
...
fname       = 'Figure7d.pdf'
fileName    = fname#BasicPath + fname;
...
p2,=plt.plot(order3n2[:,0],cd_3n2[:,1],'*',color=[0.0,1,0],lw=8,     markersize=15,label=r'$  \,\,\,= 330$')
...
#plt.ylabel(r'$\rm Dichroism$', fontsize=34);
plt.xlabel(r'$\rm Harmonic\,\,Order$', fontsize=34);
plt.text(0.3, 1.06e-0, r'$\rm (f)\,Topological\,\,3n+2$', fontsize=27, color="k");
#plt.text(1, 1e-0, r'$\rm\,\,\,\,\,    Topological\,\,\,3n+2$', fontsize=28, color="k");
