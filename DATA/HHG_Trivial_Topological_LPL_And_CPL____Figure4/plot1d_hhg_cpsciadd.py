...
p1,=plt.plot( om, hhgtriv + hzero, 'b', lw=3   );
plt.plot( om, hhgtriv + hzero, 'b', lw=10, alpha=0.2   );
#p2,=plt.plot( om, hhgtopo + hzero, '-r', lw=2 );

plt.fill_between( om, hzero, hhgtriv, color=[1,0.9,0], alpha=0.61 )
...
plt.xlabel(r'$\rm \omega/\omega_0$', fontsize=37,color='w' );

ax.set_facecolor((.18, .31, .31) );
...
p2,=plt.plot( om, hhgtopo + hzero, '-r', lw=3 );
p3,=plt.plot( om, hhgtopo + hzero, '-r', lw=10,alpha=0.2 );

plt.fill_between( om, hzero, hhgtopo, color=[0.0,0.9,0], alpha=0.61 )

#plt.fill_between( om, hhgtopo,  color=[1,1,1], alpha=0.71 )
...
#fig.patch.set_facecolor('xkcd:mint ')
